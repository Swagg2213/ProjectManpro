<div class="fixed navbar bg-[#125098] shadow-lg md:py-3 z-50">
    <div class="navbar-start">
        ...
        <div class="w-16 ml-3 md:w-20 md:ml-10 text-xl font-bold text-white">
            MAHANAIM
        </div>
        ...
        <div class="navbar-center hidden lg:flex text-md text-white">
