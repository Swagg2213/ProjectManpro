...
<form class="w-3/5 max-w-full mx-auto" method="POST" action="/jemaat/add">
    ...
    <div class="relative z-0 w-full mb-5 group">
        <input type="number" name="noHp" id="" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none border-gray-600 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
    ...
    <div class="grid md:grid-cols-2 md:gap-6">
      ...
      <div class="relative z-0 w-full mb-5 group">
          <input type="date" name="tanggalLahir" id="floating_last_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none border-gray-600 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
